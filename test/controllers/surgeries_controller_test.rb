...
class SurgeriesControllerTest < ActionController::TestCase
  ...
  test "should create surgery" do
    assert_difference('Surgery.count') do
      post :create, surgery: { S_date: @surgery.S_date, description: @surgery.description, patient_id: @surgery.patient_id, place: @surgery.place, user_id: @surgery.user_id }
    end
  ...
  test "should update surgery" do
    patch :update, id: @surgery, surgery: { S_date: @surgery.S_date, description: @surgery.description, patient_id: @surgery.patient_id, place: @surgery.place, user_id: @surgery.user_id }
    assert_redirected_to surgery_path(assigns(:surgery))
  end

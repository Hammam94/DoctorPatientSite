...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { phone_number: @phone.phone_number, treatment_center_id: @phone.treatment_center_id }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { phone_number: @phone.phone_number, treatment_center_id: @phone.treatment_center_id }
    assert_redirected_to phone_path(assigns(:phone))
  end
